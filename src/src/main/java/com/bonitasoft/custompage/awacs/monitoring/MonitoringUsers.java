    ...
    public static HashMap<String, Object> monitorUsers(final MonitorUsersInput monitorUsersInput, final IdentityAPI identityAPI, final ProcessAPI processAPI) {
        ...
        try
        {
            ...
            for (final ActivityItem activityItem : mapActivityItem.values())
            {
                ...
                {
                    if (activityItem.dateReady != null && activityItem.dateComplete != null && humanTaskDefinition.getExpectedDuration() != null)
                    {
                        activityItem.isOverflowed = activityItem.dateComplete.getTime() - activityItem.dateReady.getTime() > humanTaskDefinition.getExpectedDuration();
                    }
                }
